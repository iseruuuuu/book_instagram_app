...
class _$RootScreenStateTearOff {
  ...
  _RootScreenState call() {
    return const _RootScreenState();
  }
}
...
class _$_RootScreenState implements _RootScreenState {
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) || (other is _RootScreenState);
  }
...
abstract class _RootScreenState implements RootScreenState {
  const factory _RootScreenState() = _$_RootScreenState;
}
